<div class="card shadow-sm">
        <div class="card-header bg-primary text-white">
            <h3 class="card-title mb-0" style="color:white">{{ $project->item_name }}</h3>
        </div>
                ...
                <div class="col-md-6">
                    <div class="info-section">
                        <h5 class="section-title border-bottom pb-2 mb-3">
                            ...
                            <span class="badge bg-secondary float-end" style="color:white">{{ $project->technicalFiles->count() }}</span>
                        </h5>
